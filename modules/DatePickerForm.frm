...
Public Target As MSForms.Label
...
Private Sub UserForm_Activate()
    ...
    If IsDate(Target.Caption) Then
        Calendar1.Value = CDate(Target.Caption)
    End If
...
Sub CloseDatePicker(Save As Boolean)
    If Save And Not Target Is Nothing And IsDate(Calendar1.Value) Then
        Target.Caption = Calendar1.Value
    End If
    Set Target = Nothing
    Me.Hide
End Sub
