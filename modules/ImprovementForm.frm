VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ImprovementForm 
   Caption         =   "Виды благоустройства"
   ClientHeight    =   9435
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13755
   OleObjectBlob   =   "ImprovementForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "ImprovementForm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private curItem As New improvement_class
...
' ----------------------------------------------------------------------------
    Set curItem = improvement_list(CStr(Item))
...
' Last update: 25.03.2018
' ----------------------------------------------------------------------------
    Set curItem = New improvement_class
...
' ----------------------------------------------------------------------------
    ...
    For i = 1 To improvement_list.count
        Set curItem = improvement_list(i)
